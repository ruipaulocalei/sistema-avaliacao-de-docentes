            ...
            <div class=" bg-white border-b border-gray-200">
                ...
                @if (count($departamentos) > 0)
                         ...
                         divide-y divide-gray-200">
                            <thead class="bg-purple-900 text-white mb-4">
                                <tr class=" px-4">
                                    ...
                                    <th class="px-6 py-3 text-left uppercase text-sm leading-4 font-medium">Nome
                                    </th>
                    ...
                    leading-5 font-medium">
                                            ...
                                            <button wire:click="$emit('mostrarAlerta', {{ $departamento->id }})"
                ...
                @else
                    <h2 class="text-center
                     text-red-600 font-bold text-xl">Sem departamentos criados</h2>
                @endif
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        Livewire.on('mostrarAlerta', departamentoId => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emit('eliminarDepartamento', departamentoId)
                    Swal.fire(
                        'Excluído!',
