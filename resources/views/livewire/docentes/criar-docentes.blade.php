<form class="w-full space-y-4 mx-auto" wire:submit.prevent="criarDocente">
    ...
    <div class="mt-4">
        ...
        <input type="password" class="block w-2/5 rounded-md p-3
        mt-1 border border-gray-200 focus:outline-none"
            wire:model="password" value="{{ old('password') }}"
